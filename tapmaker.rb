...
class TapMaker
    ...
    def append_raw(file_name)
        @data += File.read(file_name).bytes
    end
...
tm = TapMaker.new
tm.append_raw(File.dirname(__FILE__) + '/_build/fool-loader.tap')
tm.append_file(File.dirname(__FILE__) + '/_build/fool-code.bin', false, 3, "1b-basic", 32768)
tm.save(File.dirname(__FILE__) + '/_build/1b-basic.tap')
